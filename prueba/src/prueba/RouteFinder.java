...
public class RouteFinder {
	...
	public static void main(String[] args) {
		...
		int numObstaculos = problema.obst;
		...
		robotSetups[indice]=new RobotSetup(          100.0,        //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT
				                                     360.0,        //AQUÃ� DEBE FIGURAR LA COLUMNA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT    
	...
	//	for (int f = 0; f < nFil; f++){
		//	for (int c = 0; c < nCol; c++){
			//	if {//SI HAY OBSTÃ�CULO EN ESA POSICIÃ“N DE LA MALLA
					
					existingRobots[indice]=modelRobots[0];   //sittingDuck
					
					
					robotSetups[indice]=  new RobotSetup(  36.0,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA CELDA DONDE HAY OBSTÃ�CULO
							                               36.0,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA COLUMNA DONDE HAY OBSTÃ�CULO
							                             0.0);    //orientaciÃ³n
					indice++;
